...
- ALWAYS ask for explicit user confirmation before pushing any changes to a remote repository (e.g., git push). Never assume permission to push, even for fixes.
