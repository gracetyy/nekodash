...
func _ready() -> void:
	...
	assert(_show_input_hints_toggle != null, "_show_input_hints_toggle not assigned")
...
func _on_show_input_hints_toggled(button_pressed: bool) -> void:
	if _suppress_events:
		return
	_app_settings_ref.set_show_input_hints(button_pressed)
	_refresh_keyboard_hint_visibility()
...
func _refresh_keyboard_hint_visibility() -> void:
	if _keyboard_hint_row == null or _app_settings_ref == null:
		return
	var show_hints: bool = _get_show_input_hints()
...
func _get_show_input_hints() -> bool:
	if _app_settings_ref != null and _app_settings_ref.has_method("get_show_input_hints"):
		return _app_settings_ref.get_show_input_hints()
	return AppSettings.get_show_input_hints()
