...
| ----------------------------- | -------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------- | --------- | --------- | ------ | --------------------------- |
| `cat_default_idle.png`        | Default white cat, sitting/idle pose. Used on main menu, inside modals, skin select preview. | White fur, dark outline 2–3px, pink blush circles, large round eyes, relaxed tail curl. | 64×64     | Procreate | PNG    | ✅ draft (`sprite-cat.png`) |
