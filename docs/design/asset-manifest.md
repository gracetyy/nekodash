...
| `cat_default_excited.png`    | Excited expression used for 3-star completion outcomes.                 | Energetic happy expression for perfect/high score states.                               | 320×320   | Procreate | PNG    | ✅     |
