...
| S1-06 | Mobile validation — deploy S1-05 build to device; trial TRANS_EXPO easing; record swipe accuracy (target ≥15/20); lock easing decision                                                      | qa-tester                 | 0.5       | S1-05               | Written decision in sprint notes: easing curve chosen (TRANS_QUAD vs TRANS_EXPO); swipe accuracy recorded; any threshold adjustments noted as GDD change requests          |
